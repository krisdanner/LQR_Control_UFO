% Controle LQR para estabilização de uma nave em órbita
...
% Control Law
Q = [100 0;  % Penalize angular error (+ diminui o tempo, - aumenta o tempo)
     0 0.01]; % Penalize angular rate (+ diminui o consumo, - aumenta o consumo)
R = 0.01;     % Penalize thruster effort (+ diminui o consumo, - aumenta o consumo)
K = lqr(A,B,Q,R);
...
fig = figure('Position', [300 40 800 640]);
h3 = subplot(3, 1, 3);
...
h3.GridColor = 'w';
h3.GridAlpha = 0.5;
text(8, 1.5, 'Aceleração', 'Color', [1 0 0], 'FontSize', 24)
...
axis([0 12 -.5 3.5]);
h2.Color = [0 0 0];
text(8, 2.5, 'Erro Angular', 'Color', [0 1 0], 'FontSize', 24)
...
text(-3, 3, 'Tempo:                 segundos', 'Color', [1 1 1], 'FontSize', 20,...
    'HorizontalAlignment', 'left');
text(-3, 2.7, 'Combustível:        litros', 'Color', [1 1 1], 'FontSize', 20,...
    'HorizontalAlignment', 'left');

TME = text(-1, 3, num2str(current_time, '%.1f'), 'Color', [0 1 0], ...
'FontSize', 20, 'HorizontalAlignment', 'right');
FUL = text(-1, 2.7, num2str(fuel, '%.0f'), 'Color', [1 0 0], ...
'FontSize', 20, 'HorizontalAlignment', 'right');
